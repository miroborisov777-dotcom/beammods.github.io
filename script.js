...
async function loadMods() {
    try {
        ...
        document.getElementById('mods').innerHTML = "<p style='color:red; padding:20px;'>Error: mods.json not found.</p>";
    }
}
...
function renderMods(mods) {
    ...
    if (mods.length === 0) {
        container.innerHTML = "<p style='color:#555; padding: 20px;'>No mods found.</p>";
        return;
    }
